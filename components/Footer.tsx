...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-orange bg-opacity-5 pt-10 md:pt-10 lg:pt-15"
        data-wow-delay=".1s"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center justify-center gap-x-2 mb-4 sm:mb-2">
                  <Image
                    height={100}
                    width={100}
                    src="/img/yowyob/om.svg"
                    alt="Orange Money"
                  />
                  <Image
                    height={35}
                    width={35}
                    src="/img/yowyob/mtn_momo.svg"
                    alt="MTN MoMo"
                  />
                  ...
                  <Image
                    height={60}
                    width={60}
                    src="/img/yowyob/master_card.png"
                    alt="master card"
                  />
                </div>
                ...
                <div className="flex items-center px-4">
                  <a
                    ...
                    className="mr-6 text-[#CED3F6] hover:text-secondary"
                  >
                    <svg
                      width="9"
                      height="18"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-orange ">
                  Useful Links
                </h2>
                <ul>
                  <li>
                    <a
                      href="http://services.yowyob.com/create-shop/advantage"
                  ...
                  <li>
                    <Link
                      href="http://services.yowyob.com/delivery/advantage"
                      className="mb-4 inline-block text-base font-medium text-body-color  hover:text-secondary"
                    >
                      {" "}
                      YowYob Delivery{" "}
                  ...
                  <li>
                    <Link
                      href="http://services.yowyob.com/manage-business"
                      className="mb-4 inline-block text-base font-medium text-body-color  hover:text-secondary"
                    >
                      {" "}
                      Manage Your Company{" "}
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="https://shopping.yowyob.com/our-company/careers"
                      className="mb-4 inline-block text-base font-medium text-body-color  hover:text-secondary"
                    >
                      {" "}
                      We are hiring{" "}
                  ...
                  <li>
                    <a
                      href="https://shopping.yowyob.com/our-company/contact-us"
                      className="mb-4 inline-block text-base font-medium text-body-color  hover:text-secondary"
                    >
                      {" "}
                      Contact{" "}
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="https://shopping.yowyob.com/terms/cookie"
                      className="mb-4 inline-block text-base font-medium text-body-color  hover:text-secondary"
                    >
                      {" "}
                  ...
                  <li>
                    <a
                      href="https://shopping.yowyob.com/terms/personal-information"
                      className="mb-4 inline-block text-base font-medium text-body-color  hover:text-secondary"
                    >
                      {" "}
